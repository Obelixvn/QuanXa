...
$tsql = "Select Convert(date, OpenDateTime) as Ngay, DATEPART( hh,OpenDateTime) as Time,sum(Total) From OrderList Where OpenDateTime >= '2018-05-30' AND OpenDateTime <= '2018-05-30' GROUP BY DATEPART( hh,OpenDateTime) , Convert(date, OpenDateTime) ";
$tsql1 = "SELECT Top 10 *  From OrderList WHERE SaleNoneVAT > 0 AND TableID > 200 Order By OpenDateTime Desc ";
